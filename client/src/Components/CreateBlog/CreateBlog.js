...
function CreateBlog() {
  ...
  const createBlogHandler = async (event) => {
    ...
    const imageRef = ref(storage, `blogImages/${currImageName}`);
  ...
  return (
    <div id={style.blogInputContainer}>
      <form method="POST" action="/create-blog" onSubmit={createBlogHandler}>
